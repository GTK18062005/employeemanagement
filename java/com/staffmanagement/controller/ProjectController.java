...
public class ProjectController {
    ...
    // ✅ EMPLOYEE: View own projects/tasks (no role restriction)
    ...
    // ✅ MANAGER/ADMIN ONLY: Create/update projects & tasks
    ...
    // ✅ EMPLOYEE: Update own task status (no manager needed)
